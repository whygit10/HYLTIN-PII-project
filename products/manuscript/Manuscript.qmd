...
```{=html}
<iframe src="/HYLTIN-PII-project/results/figures/html-widgets/new-cat-table.html" width="100%" height="800px" align="centered"></iframe>
```
\
...
```{=html}
<iframe src="/HYLTIN-PII-project/results/figures/static-plots/aggregated-ljung.html" width="100%" height="250px" align="centered"></iframe>
```
\
...
```{=html}
<iframe src="/HYLTIN-PII-project/results/figures/static-plots/actual-vs-forecast.html" width="100%" height="400px" align="centered"></iframe>
```
